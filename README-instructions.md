...
```shell
git clone https://github.com/The-AI-Alliance/trust-policy-contrib.git
cd trust-policy-contrib
```
...
Your website should be published after a few minutes to `https://the-ai-alliance.github.io/trust-policy-contrib/``.
