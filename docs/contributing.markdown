...
* Post a [discussion topic](https://github.com/The-AI-Alliance/trust-policy-contrib/discussions){:target="discussions"} 
* Post an [issue](https://github.com/The-AI-Alliance/trust-policy-contrib/issues){:target="issues"} 
	* See also the [project board](https://github.com/orgs/The-AI-Alliance/projects/39/){:target="dashboard"}
* Send us [email](mailto:contact@thealliance.ai?subject=Suggestions for Trust Policy - Community Contributions). This is a general email address, so be sure to mention this particular project.
...
The sources for this website are in the GitHub repo's [`docs`](https://github.com/The-AI-Alliance/trust-policy-contrib/tree/main/docs){:target="repo-docs"} directory. 
